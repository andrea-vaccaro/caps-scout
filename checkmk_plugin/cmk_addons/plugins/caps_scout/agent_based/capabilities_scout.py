...
`snmp_match.py`'s `caps/snmp/<family>` labels are a second,
...
too, this plugin also subscribes to the raw `caps_scout_snmp_match`
SNMP section (the same `SysInfo` of `sysDescr`/`sysObjectID`) and calls
`host_label_snmp_match` on it directly, reusing the exact same
...
the next action, same spirit as `snmp_match.py`'s labels. This deliberately
...
from .snmp_match import SysInfo, host_label_snmp_match
...
# Icons for all 117 `caps/snmp/<family>` labels (see `snmp_match.py`,
...
DISPLAY_NAME_BY_LABEL: Mapping[str, str] = {
    ...
    "caps/snmp/cisco": "Cisco",
    "caps/snmp/juniper": "Juniper Networks",
    "caps/snmp/fortinet": "Fortinet",
    "caps/snmp/aruba": "Aruba Networks",
    "caps/snmp/hp_procurve": "HP ProCurve",
    "caps/snmp/checkpoint": "Check Point",
    "caps/snmp/palo_alto": "Palo Alto Networks",
    "caps/snmp/f5_bigip": "F5 BIG-IP",
    "caps/snmp/acme": 'Acme Packet',
    "caps/snmp/adva": 'ADVA',
    "caps/snmp/akcp": 'AKCP',
    "caps/snmp/alcatel": 'Alcatel',
    "caps/snmp/apc": 'APC',
    "caps/snmp/arbor": 'Arbor Networks',
    "caps/snmp/arris": 'Arris',
    "caps/snmp/atto": 'ATTO Technology',
    "caps/snmp/audiocodes": 'AudioCodes',
    "caps/snmp/avaya": 'Avaya',
    "caps/snmp/barracuda": 'Barracuda Networks',
    "caps/snmp/bintec": 'Bintec/Teldat',
    "caps/snmp/blade": 'IBM/Lenovo BladeCenter',
    "caps/snmp/bluecat": 'BlueCat',
    "caps/snmp/bluecoat": 'Blue Coat',
    "caps/snmp/brocade": 'Brocade',
    "caps/snmp/bvip": 'Bosch VIP',
    "caps/snmp/casa": 'Casa Systems',
    "caps/snmp/ciena_ces": 'Ciena CES',
    "caps/snmp/datapower": 'IBM DataPower',
    "caps/snmp/decru": 'NetApp Decru',
    "caps/snmp/didactum": 'Didactum',
    "caps/snmp/docsis": 'DOCSIS Cable Modem',
    "caps/snmp/eltek": 'Eltek',
    "caps/snmp/emc": 'Dell EMC',
    "caps/snmp/enterasys": 'Enterasys',
    "caps/snmp/enviromux": 'Enviromux',
    "caps/snmp/epson": 'Epson',
    "caps/snmp/fireeye": 'FireEye',
    "caps/snmp/fjdarye": 'Fujitsu ETERNUS',
    "caps/snmp/genua": 'genua',
    "caps/snmp/gude": 'Gude',
    "caps/snmp/h3c": 'H3C/3Com',
    "caps/snmp/hitachi": 'Hitachi HUS',
    "caps/snmp/hitachi_hnas": 'Hitachi HNAS',
    "caps/snmp/hp": 'HP ProLiant/EML',
    "caps/snmp/hp_blade": 'HP BladeSystem',
    "caps/snmp/hpux": 'HP-UX',
    "caps/snmp/huawei": 'Huawei',
    "caps/snmp/hwg": 'HW group',
    "caps/snmp/icom": 'Icom Repeater',
    "caps/snmp/infoblox": 'Infoblox',
    "caps/snmp/innovaphone": 'innovaphone',
    "caps/snmp/intel_true_scale": 'Intel TrueScale',
    "caps/snmp/ispro": 'ISPRO',
    "caps/snmp/janitza": 'Janitza',
    "caps/snmp/kemp_loadmaster": 'Kemp LoadMaster',
    "caps/snmp/kentix": 'Kentix',
    "caps/snmp/knuerr": 'Knuerr',
    "caps/snmp/kyocera": 'Kyocera',
    "caps/snmp/lgp": 'Liebert LGP',
    "caps/snmp/liebert": 'Liebert/Emerson',
    "caps/snmp/mcafee": 'McAfee',
    "caps/snmp/meinberg": 'Meinberg',
    "caps/snmp/meraki": 'Cisco Meraki',
    "caps/snmp/mikrotik": 'MikroTik',
    "caps/snmp/moxa": 'Moxa',
    "caps/snmp/netextreme": 'Avaya/Extreme VSP',
    "caps/snmp/netgear": 'Netgear',
    "caps/snmp/netscaler": 'Citrix NetScaler',
    "caps/snmp/nimble": 'Nimble Storage',
    "caps/snmp/pandacom": 'Pandacom',
    "caps/snmp/papouch": 'Papouch',
    "caps/snmp/perle": 'Perle',
    "caps/snmp/pfsense": 'pfSense',
    "caps/snmp/poseidon": 'Poseidon',
    "caps/snmp/printer": 'Ricoh/Canon Printer',
    "caps/snmp/pulse_secure": 'Pulse Secure',
    "caps/snmp/qlogic": 'QLogic',
    "caps/snmp/qnap": 'QNAP',
    "caps/snmp/raritan": 'Raritan',
    "caps/snmp/rittal": 'Rittal CMC',
    "caps/snmp/roomalert": 'AVTECH Room Alert',
    "caps/snmp/safenet": 'SafeNet HSM',
    "caps/snmp/sentry": 'Sentry PDU',
    "caps/snmp/silverpeak": 'Silver Peak',
    "caps/snmp/sni_octopuse": 'Siemens HiPath/OpenScape',
    "caps/snmp/sophos": 'Sophos',
    "caps/snmp/steelhead": 'Riverbed Steelhead',
    "caps/snmp/teracom": 'Teracom',
    "caps/snmp/ups": 'UPS (Generic)',
    "caps/snmp/vutlan": 'Vutlan',
    "caps/snmp/wagner": 'Wagner Titanus',
    "caps/snmp/watchdog": 'Watchdog Sensors',
    "caps/snmp/wut": 'W&T',
    "caps/snmp/zebra": 'Zebra Technologies',
    "caps/snmp/bdt_tape": 'BDT Tape Library',
    "caps/snmp/bluenet": 'BayTech BlueNET',
    "caps/snmp/cbl": 'CBL AirLaser',
    "caps/snmp/cisco_sma": 'Cisco Secure Email/Web Manager',
    "caps/snmp/climaveneta": 'Climaveneta',
    "caps/snmp/cpsecure": 'CoreProcess Secure',
    "caps/snmp/netapp": 'NetApp Filer',
    "caps/snmp/emka": 'EMKA Enclosure Monitoring',
    "caps/snmp/ewon": 'eWON',
    "caps/snmp/f5os_rseries": 'F5 rSeries',
    "caps/snmp/hepta": 'Hepta UPS',
    "caps/snmp/hp_hh3c": 'HPE/H3C',
    "caps/snmp/hp_mcs": 'HP Modular Cooling System',
    "caps/snmp/infratec_plus": 'Infratec Plus RMS200',
    "caps/snmp/ipr400": 'IPR400 VoIP Intercom',
    "caps/snmp/orion": 'Orion UPS',
    "caps/snmp/packeteer": 'Packeteer PacketShaper',
    "caps/snmp/seh": 'SEH PSrv',
    "caps/snmp/sensatronics": 'Sensatronics',
    "caps/snmp/strem1": 'Sensatronics EM1',
    "caps/snmp/superstack3": '3Com SuperStack 3',
    "caps/snmp/sym_brightmail": 'Symantec Brightmail',
    "caps/snmp/arista": 'Arista Networks',
}


# Icons for every `caps/*` label in the README's "Detected capabilities" table, plus
# the `caps/snmp/<family>` labels from `snmp_match.py` - see the
...
ICON_BY_LABEL: Mapping[str, str] = {
    ...
    "caps/snmp/cisco": _ICON_CISCO,
    "caps/snmp/juniper": _ICON_JUNIPER,
    "caps/snmp/fortinet": _ICON_FORTINET,
    "caps/snmp/aruba": _ICON_ARUBA,
    "caps/snmp/hp_procurve": _ICON_HP,
    "caps/snmp/checkpoint": _ICON_CHECKPOINT,
    "caps/snmp/palo_alto": _ICON_PALO_ALTO,
    "caps/snmp/f5_bigip": _ICON_F5,
    "caps/snmp/acme": _ICON_GENERIC_NETWORK,
    "caps/snmp/adva": _ICON_GENERIC_NETWORK,
    "caps/snmp/akcp": _ICON_GENERIC_SENSOR,
    "caps/snmp/alcatel": _ICON_GENERIC_NETWORK,
    "caps/snmp/apc": _ICON_SCHNEIDER_ELECTRIC,
    "caps/snmp/arbor": _ICON_GENERIC_NETWORK,
    "caps/snmp/arris": _ICON_GENERIC_NETWORK,
    "caps/snmp/atto": _ICON_GENERIC_NETWORK,
    "caps/snmp/audiocodes": _ICON_GENERIC_NETWORK,
    "caps/snmp/avaya": _ICON_GENERIC_NETWORK,
    "caps/snmp/barracuda": _ICON_GENERIC_NETWORK,
    "caps/snmp/bintec": _ICON_GENERIC_NETWORK,
    "caps/snmp/blade": _ICON_GENERIC_NETWORK,
    "caps/snmp/bluecat": _ICON_GENERIC_NETWORK,
    "caps/snmp/bluecoat": _ICON_GENERIC_NETWORK,
    "caps/snmp/brocade": _ICON_GENERIC_NETWORK,
    "caps/snmp/bvip": _ICON_BOSCH,
    "caps/snmp/casa": _ICON_GENERIC_NETWORK,
    "caps/snmp/ciena_ces": _ICON_GENERIC_NETWORK,
    "caps/snmp/datapower": _ICON_GENERIC_NETWORK,
    "caps/snmp/decru": _ICON_NETAPP,
    "caps/snmp/didactum": _ICON_GENERIC_SENSOR,
    "caps/snmp/docsis": _ICON_GENERIC_NETWORK,
    "caps/snmp/eltek": _ICON_GENERIC_POWER,
    "caps/snmp/emc": _ICON_DELL,
    "caps/snmp/enterasys": _ICON_GENERIC_NETWORK,
    "caps/snmp/enviromux": _ICON_GENERIC_SENSOR,
    "caps/snmp/epson": _ICON_EPSON,
    "caps/snmp/fireeye": _ICON_GENERIC_NETWORK,
    "caps/snmp/fjdarye": _ICON_FUJITSU,
    "caps/snmp/genua": _ICON_GENERIC_NETWORK,
    "caps/snmp/gude": _ICON_GENERIC_SENSOR,
    "caps/snmp/h3c": _ICON_GENERIC_NETWORK,
    "caps/snmp/hitachi": _ICON_HITACHI,
    "caps/snmp/hitachi_hnas": _ICON_HITACHI,
    "caps/snmp/hp": _ICON_HP,
    "caps/snmp/hp_blade": _ICON_HP,
    "caps/snmp/hpux": _ICON_HP,
    "caps/snmp/huawei": _ICON_HUAWEI,
    "caps/snmp/hwg": _ICON_GENERIC_SENSOR,
    "caps/snmp/icom": _ICON_GENERIC_NETWORK,
    "caps/snmp/infoblox": _ICON_GENERIC_NETWORK,
    "caps/snmp/innovaphone": _ICON_GENERIC_NETWORK,
    "caps/snmp/intel_true_scale": _ICON_INTEL,
    "caps/snmp/ispro": _ICON_GENERIC_SENSOR,
    "caps/snmp/janitza": _ICON_GENERIC_SENSOR,
    "caps/snmp/kemp_loadmaster": _ICON_PROGRESS,
    "caps/snmp/kentix": _ICON_GENERIC_SENSOR,
    "caps/snmp/knuerr": _ICON_GENERIC_POWER,
    "caps/snmp/kyocera": _ICON_KYOCERA,
    "caps/snmp/lgp": _ICON_GENERIC_POWER,
    "caps/snmp/liebert": _ICON_GENERIC_POWER,
    "caps/snmp/mcafee": _ICON_MCAFEE,
    "caps/snmp/meinberg": _ICON_GENERIC_NETWORK,
    "caps/snmp/meraki": _ICON_CISCO,
    "caps/snmp/mikrotik": _ICON_MIKROTIK,
    "caps/snmp/moxa": _ICON_GENERIC_NETWORK,
    "caps/snmp/netextreme": _ICON_GENERIC_NETWORK,
    "caps/snmp/netgear": _ICON_NETGEAR,
    "caps/snmp/netscaler": _ICON_CITRIX,
    "caps/snmp/nimble": _ICON_GENERIC_NETWORK,
    "caps/snmp/pandacom": _ICON_GENERIC_NETWORK,
    "caps/snmp/papouch": _ICON_GENERIC_SENSOR,
    "caps/snmp/perle": _ICON_GENERIC_NETWORK,
    "caps/snmp/pfsense": _ICON_PFSENSE,
    "caps/snmp/poseidon": _ICON_GENERIC_SENSOR,
    "caps/snmp/printer": _ICON_GENERIC_PRINTER,
    "caps/snmp/pulse_secure": _ICON_GENERIC_NETWORK,
    "caps/snmp/qlogic": _ICON_GENERIC_NETWORK,
    "caps/snmp/qnap": _ICON_QNAP,
    "caps/snmp/raritan": _ICON_GENERIC_POWER,
    "caps/snmp/rittal": _ICON_GENERIC_POWER,
    "caps/snmp/roomalert": _ICON_GENERIC_SENSOR,
    "caps/snmp/safenet": _ICON_GENERIC_NETWORK,
    "caps/snmp/sentry": _ICON_GENERIC_POWER,
    "caps/snmp/silverpeak": _ICON_GENERIC_NETWORK,
    "caps/snmp/sni_octopuse": _ICON_SIEMENS,
    "caps/snmp/sophos": _ICON_GENERIC_NETWORK,
    "caps/snmp/steelhead": _ICON_GENERIC_NETWORK,
    "caps/snmp/teracom": _ICON_GENERIC_SENSOR,
    "caps/snmp/ups": _ICON_GENERIC_POWER,
    "caps/snmp/vutlan": _ICON_GENERIC_SENSOR,
    "caps/snmp/wagner": _ICON_GENERIC_SENSOR,
    "caps/snmp/watchdog": _ICON_GENERIC_SENSOR,
    "caps/snmp/wut": _ICON_GENERIC_SENSOR,
    "caps/snmp/zebra": _ICON_ZEBRA,
    "caps/snmp/bdt_tape": _ICON_GENERIC_NETWORK,
    "caps/snmp/bluenet": _ICON_GENERIC_POWER,
    "caps/snmp/cbl": _ICON_GENERIC_NETWORK,
    "caps/snmp/cisco_sma": _ICON_CISCO,
    "caps/snmp/climaveneta": _ICON_GENERIC_SENSOR,
    "caps/snmp/cpsecure": _ICON_GENERIC_NETWORK,
    "caps/snmp/netapp": _ICON_NETAPP,
    "caps/snmp/emka": _ICON_GENERIC_SENSOR,
    "caps/snmp/ewon": _ICON_GENERIC_NETWORK,
    "caps/snmp/f5os_rseries": _ICON_F5,
    "caps/snmp/hepta": _ICON_GENERIC_POWER,
    "caps/snmp/hp_hh3c": _ICON_GENERIC_NETWORK,
    "caps/snmp/hp_mcs": _ICON_HP,
    "caps/snmp/infratec_plus": _ICON_GENERIC_SENSOR,
    "caps/snmp/ipr400": _ICON_GENERIC_NETWORK,
    "caps/snmp/orion": _ICON_GENERIC_POWER,
    "caps/snmp/packeteer": _ICON_GENERIC_NETWORK,
    "caps/snmp/seh": _ICON_GENERIC_PRINTER,
    "caps/snmp/sensatronics": _ICON_GENERIC_SENSOR,
    "caps/snmp/strem1": _ICON_GENERIC_SENSOR,
    "caps/snmp/superstack3": _ICON_GENERIC_NETWORK,
    "caps/snmp/sym_brightmail": _ICON_SYMANTEC,
    "caps/snmp/arista": _ICON_ARISTA,
}


def _caps_labels(
    section_labels: Section | None,
    section_caps_scout_snmp_match: SysInfo | None,
) -> list[str]:
    from_agent = (
    ...
    from_snmp = (
        (label.name for label in host_label_snmp_match(section_caps_scout_snmp_match))
        if section_caps_scout_snmp_match is not None
        else ()
    )
...
def discover_capabilities_scout(
    ...
    if _caps_labels(section_labels, section_caps_scout_snmp_match):
        yield Service()
...
def check_capabilities_scout(
    ...
    caps = _caps_labels(section_labels, section_caps_scout_snmp_match)
    if not caps:
...
check_plugin_capabilities_scout = CheckPlugin(
    ...
    sections=["labels", "caps_scout_snmp_match"],
